package com.mfcwl.rxjavaandroid.operators.transformationoperators.flatmapoperator;
...
import com.mfcwl.rxjavaandroid.operators.transformationoperators.flatmapoperator.requests.ServiceGenerator;
...
public class MainActivity16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*FlatMap Doesn't preserve order in which they are executed*/
        getPostsObservable()
                .subscribeOn(Schedulers.io())
                .flatMap(new Function<Post, ObservableSource<Post>>() { /*Here, It is returning post obervable using
                which comments api is called and updated.*/
                    @Override
    ...
    private Observable<Post> getPostsObservable() {
        return ServiceGenerator.getRequestApi()
                ...
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .flatMap(new Function<List<Post>, ObservableSource<Post>>() {  /*Flat Map can return an Observable,
                                                                      Here, From post lists it creating an observable*/
                    @Override
