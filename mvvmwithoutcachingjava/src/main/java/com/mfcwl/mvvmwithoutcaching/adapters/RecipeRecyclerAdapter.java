package com.mfcwl.mvvmwithoutcaching.adapters;
...
import com.mfcwl.mvvmwithoutcaching.R;
import com.mfcwl.mvvmwithoutcaching.models.Recipe;
import com.mfcwl.mvvmwithoutcaching.util.Constants;
...
public class RecipeRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (itemViewType == RECIPE_TYPE) {
            ...
            Uri path = Uri.parse("android.resource://com.mfcwl.mvvmwithoutcaching/drawable/" + mRecipes.get(i).getImage_url());
            Glide.with(viewHolder.itemView.getContext())
                    .setDefaultRequestOptions(requestOptions)
                    .load(path)
