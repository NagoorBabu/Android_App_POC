...
import com.mfcwl.rxjavaandroid.operators.transformationoperators.switchmapoperator.requests.ServiceGenerator;
...
/*SwitchMap() will transform items emitted by an Observable into an Observable just like ConcatMap() and FlatMap().
The difference being that it will unsubscribe previous observers once a new Observer has subscribed.
Essentially this solves a limitation that both ConcatMap() and FlatMap() have.*/
public class MainActivity18 extends AppCompatActivity implements RecyclerAdapter.OnPostClickListener {

    private static final String TAG = "MainActivity18";
